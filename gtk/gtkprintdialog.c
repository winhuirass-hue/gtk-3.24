 ...
 * @self: a `GtkPrintDialog`
 *
 * Returns whether the print dialog lets the  user select 'current page'
 * for what pages to print.
 *
 ...
 *
 * Set whether the print dialog lets the user select 'current page'
 * for what pages to print.
 *
 * This is only useful when using [method@Gtk.PrintDialog.setup].
 * The users' choice can be retrieved from the print settings that
 * are returned by that method, with
 ...
 * @self: a `GtkPrintDialog`
 *
 * Returns whether the print dialog lets the user select 'selection'
 * for what pages to print.
 *
 ...
 *
 * Set whether the print dialog lets the user select 'selection'
 * for what pages to print.
 *
 * This is only useful when using [method@Gtk.PrintDialog.setup].
 * The users' choice can be retrieved from the print settings that
 * are returned by that method, with [method@Gtk.PrintSettings.get_print_pages].
 *
 * Since: 4.24
 */
void
