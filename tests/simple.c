...
"}"
"grid.tiled-top > resize-handle.WNW,"
"grid.tiled-top > resize-handle.NW,"
"grid.tiled-top > resize-handle.NNW,"
"grid.tiled-top > resize-handle.N,"
"grid.tiled-top > resize-handle.NNE,"
"grid.tiled-top > resize-handle.NE,"
"grid.tiled-top > resize-handle.ENE,"
"grid.tiled-bottom > resize-handle.WSW,"
"grid.tiled-bottom > resize-handle.SW,"
"grid.tiled-bottom > resize-handle.SSW,"
"grid.tiled-bottom > resize-handle.S,"
"grid.tiled-bottom > resize-handle.SSE,"
"grid.tiled-bottom > resize-handle.SE,"
"grid.tiled-bottom > resize-handle.ESE {"
"  min-height: 0;"
"}"
"grid.tiled-left > resize-handle.NNW,"
"grid.tiled-left > resize-handle.NW,"
"grid.tiled-left > resize-handle.WNW,"
"grid.tiled-left > resize-handle.W,"
"grid.tiled-left > resize-handle.WSW,"
"grid.tiled-left > resize-handle.SW,"
"grid.tiled-left > resize-handle.SSW,"
"grid.tiled-right > resize-handle.NNE,"
"grid.tiled-right > resize-handle.NE,"
"grid.tiled-right > resize-handle.ENE,"
"grid.tiled-right > resize-handle.E,"
"grid.tiled-right > resize-handle.ESE,"
"grid.tiled-right > resize-handle.SE,"
"grid.tiled-right > resize-handle.SSE {"
"  min-width: 0;"
"}";
...
main (int argc, char *argv[])
{
  ...
  gtk_widget_add_css_class (grid, "tiled-left");
